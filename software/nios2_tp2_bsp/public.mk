...
SOPCINFO_FILE := C:/SoC_Project/TP_Montre.sopcinfo
...
# Design Name 
# setting SOPC_NAME is TP_Montre
SOPC_NAME := TP_Montre
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001078
SOPC_SYSID_FLAG += --sidp=0x1001078
ELF_PATCH_FLAG  += --sidp 0x1001078

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1665655599
SOPC_SYSID_FLAG += --timestamp=1665655599
ELF_PATCH_FLAG  += --timestamp 1665655599
